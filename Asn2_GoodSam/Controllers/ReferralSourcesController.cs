...
namespace Asn2_GoodSam.Controllers
{
    ...
    public class ReferralSourcesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReferralSourceId,ReferralSourceName")] ReferralSource referralSource)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReferralSourceId,ReferralSourceName")] ReferralSource referralSource)
        {
            if (ModelState.IsValid)
            {
