...
namespace Asn2_GoodSam.Controllers
{
    ...
    public class DuplicateFilesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DuplicateFileId,DuplicateFileName")] DuplicateFile duplicateFile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DuplicateFileId,DuplicateFileName")] DuplicateFile duplicateFile)
        {
            if (ModelState.IsValid)
            {
