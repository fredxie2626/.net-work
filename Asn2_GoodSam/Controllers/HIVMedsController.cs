...
namespace Asn2_GoodSam.Controllers
{
    ...
    public class HIVMedsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HIVMedsId,HIVMedsName")] HIVMeds hIVMeds)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HIVMedsId,HIVMedsName")] HIVMeds hIVMeds)
        {
            if (ModelState.IsValid)
            {
