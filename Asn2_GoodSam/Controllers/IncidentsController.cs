...
namespace Asn2_GoodSam.Controllers
{
    ...
    public class IncidentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IncidentId,IncidentName")] Incident incident)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IncidentId,IncidentName")] Incident incident)
        {
            if (ModelState.IsValid)
            {
