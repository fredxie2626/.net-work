...
namespace Asn2_GoodSam.Controllers
{
    ...
    public class RiskStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RiskStatusId,RiskStatusName")] RiskStatus riskStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RiskStatusId,RiskStatusName")] RiskStatus riskStatus)
        {
            if (ModelState.IsValid)
            {
