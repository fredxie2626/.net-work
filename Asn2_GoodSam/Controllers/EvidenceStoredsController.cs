...
namespace Asn2_GoodSam.Controllers
{
    ...
    public class EvidenceStoredsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EvidenceStoredId,EvidenceStoredName")] EvidenceStored evidenceStored)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EvidenceStoredId,EvidenceStoredName")] EvidenceStored evidenceStored)
        {
            if (ModelState.IsValid)
            {
