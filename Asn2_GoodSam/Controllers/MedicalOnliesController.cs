...
namespace Asn2_GoodSam.Controllers
{
    ...
    public class MedicalOnliesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MedicalOnlyId,MedicalOnlyName")] MedicalOnly medicalOnly)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MedicalOnlyId,MedicalOnlyName")] MedicalOnly medicalOnly)
        {
            if (ModelState.IsValid)
            {
